...
public class DebtSimplifier {
    public List<Settlement>simplify(BalanceSheet balance) {
        ...
        PriorityQueue<Map.Entry<User, Double>>positive=new PriorityQueue<>((a,b)-> Double.compare(b.getValue(), a.getValue()));
        PriorityQueue<Map.Entry<User, Double>>negative = new PriorityQueue<>((a,b) -> Double.compare(a.getValue(),b.getValue()));
